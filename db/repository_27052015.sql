...
-- Dumping data for table repository.author: ~3 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `author_katalog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='tabel transaksi pengarang, pencipta karya pada repository';

-- Dumping data for table repository.author_katalog: ~3 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `katalog` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='tabel data katalog repository, seperti buku, kajian, video, infografis dll';

-- Dumping data for table repository.katalog: ~6 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password`, `remember_token`, `idauthor`, `role`, `created_at`, `updated_at`) VALUES
	(1, 'admin', '$2y$10$/k91IEdiOFhcyJGABp1E8OIe1jKUvOBUfCe3bBI2p1brO3Lzs98BS', 'z3WRQLqf2xjkd2vgMVZTypMgHgw1Ils4Bcl8M5p6T7taHu4GqwvbosZ3tptp', NULL, 1, '0000-00-00 00:00:00', '2015-05-25 14:25:38');
